...
import net.dolearning.libsensor.Utils;

@SuppressWarnings("unchecked")

public class BluetoothLePlugin extends CordovaPlugin {
    //Initialization related variables
    public final int REQUEST_BT_ENABLE = 59627; /*Random integer*/
    public final int REQUEST_ACCESS_FINE_LOCATION = 59628;
    public final int REQUEST_LOCATION_SOURCE_SETTINGS = 59629;
    public final int REQUEST_BLUETOOTH_SCAN = 59630;
    public final int REQUEST_BLUETOOTH_ADVERTISE = 59631;
    public final int REQUEST_BLUETOOTH_CONNECT = 59632;
    ...
    public final int STATE_UNDISCOVERED = 0;
    public final int STATE_DISCOVERING = 1;
    public final int STATE_DISCOVERED = 2;
    ...
    public final String keyError = "error";
    public final String keyMessage = "message";
    public final String keyRequest = "request";
    public final String keyStatusReceiver = "statusReceiver";
    public final String keyName = "name";
    public final String keyAddress = "address";
    public final String keyRssi = "rssi";
    public final String keyScanMode = "scanMode";
    public final String keyMatchMode = "matchMode";
    public final String keyMatchNum = "matchNum";
    public final String keyCallbackType = "callbackType";
    public final String keyAdvertisement = "advertisement";
    public final String keyUuid = "uuid";
    public final String keyService = "service";
    public final String keyServices = "services";
    public final String keyCharacteristic = "characteristic";
    public final String keyCharacteristics = "characteristics";
    public final String keyProperties = "properties";
    public final String keyPermissions = "permissions";
    public final String keyDescriptor = "descriptor";
    public final String keyDescriptors = "descriptors";
    public final String keyValue = "value";
    public final String keyType = "type";
    public final String keyIsInitialized = "isInitialized";
    public final String keyIsEnabled = "isEnabled";
    public final String keyIsScanning = "isScanning";
    public final String keyIsBonded = "isBonded";
    public final String keyIsConnected = "isConnected";
    public final String keyIsDiscovered = "isDiscovered";
    public final String keyIsDiscoverable = "isDiscoverable";
    public final String keyPeripheral = "peripheral";
    public final String keyState = "state";
    public final String keyDiscoveredState = "discoveredState";
    public final String keyConnectionPriority = "connectionPriority";
    public final String keyMtu = "mtu";
    public final String keyPin = "pin";
    public final String keyQueue = "queue";

    //Write Types
    public final String writeTypeNoResponse = "noResponse";

    //Status Types
    public final String statusEnabled = "enabled";
    public final String statusDisabled = "disabled";
    public final String statusScanStarted = "scanStarted";
    public final String statusScanStopped = "scanStopped";
    public final String statusScanResult = "scanResult";
    public final String statusBonded = "bonded";
    public final String statusBonding = "bonding";
    public final String statusUnbonded = "unbonded";
    public final String statusConnected = "connected";
    public final String statusDisconnected = "disconnected";
    public final String statusClosed = "closed";
    public final String statusDiscovered = "discovered";
    public final String statusRead = "read";
    public final String statusSubscribed = "subscribed";
    public final String statusSubscribedResult = "subscribedResult";
    public final String statusUnsubscribed = "unsubscribed";
    public final String statusWritten = "written";
    public final String statusReadDescriptor = "readDescriptor";
    public final String statusWrittenDescriptor = "writtenDescriptor";
    public final String statusRssi = "rssi";
    public final String statusConnectionPriorityRequested = "connectionPriorityRequested";
    public final String statusMtu = "mtu";

    //Properties
    public final String propertyBroadcast = "broadcast";
    public final String propertyRead = "read";
    public final String propertyWriteWithoutResponse = "writeWithoutResponse";
    public final String propertyWrite = "write";
    public final String propertyNotify = "notify";
    public final String propertyIndicate = "indicate";
    public final String propertyAuthenticatedSignedWrites = "authenticatedSignedWrites";
    public final String propertyExtendedProperties = "extendedProperties";
    public final String propertyNotifyEncryptionRequired = "notifyEncryptionRequired";
    public final String propertyIndicateEncryptionRequired = "indicateEncryptionRequired";
    public final String propertyConnectionPriorityHigh = "high";
    public final String propertyConnectionPriorityLow = "low";
    public final String propertyConnectionPriorityBalanced = "balanced";

    //Permissions
    public final String permissionRead = "read";
    public final String permissionReadEncrypted = "readEncrypted";
    public final String permissionReadEncryptedMITM = "readEncryptedMITM";
    public final String permissionWrite = "write";
    public final String permissionWriteEncrypted = "writeEncrypted";
    public final String permissionWriteEncryptedMITM = "writeEncryptedMITM";
    public final String permissionWriteSigned = "writeSigned";
    public final String permissionWriteSignedMITM = "writeSignedMITM";

    //Error Types
    public final String errorInitialize = "initialize";
    public final String errorEnable = "enable";
    public final String errorDisable = "disable";
    public final String errorArguments = "arguments";
    public final String errorStartScan = "startScan";
    public final String errorStopScan = "stopScan";
    public final String errorBond = "bond";
    public final String errorUnbond = "unbond";
    public final String errorConnect = "connect";
    public final String errorReconnect = "reconnect";
    public final String errorDiscover = "discover";
    public final String errorServices = "services";
    public final String errorCharacteristics = "characteristics";
    public final String errorDescriptors = "descriptors";
    public final String errorRead = "read";
    public final String errorSubscription = "subscription";
    public final String errorWrite = "write";
    public final String errorReadDescriptor = "readDescriptor";
    public final String errorWriteDescriptor = "writeDescriptor";
    public final String errorRssi = "rssi";
    public final String errorNeverConnected = "neverConnected";
    public final String errorIsNotDisconnected = "isNotDisconnected";
    public final String errorIsNotConnected = "isNotConnected";
    public final String errorIsDisconnected = "isDisconnected";
    public final String errorService = "service";
    public final String errorCharacteristic = "characteristic";
    public final String errorDescriptor = "descriptor";
    public final String errorRequestConnectionPriority = "requestConnectPriority";
    public final String errorMtu = "mtu";
    public final String errorRetrievePeripheralsByAddress = "retrievePeripheralsByAddress";

    //Error Messages
    //Initialization
    public final String logNotEnabled = "Bluetooth not enabled";
    public final String logNotDisabled = "Bluetooth not disabled";
    public final String logNotInit = "Bluetooth not initialized";
    public final String logOperationUnsupported = "Operation unsupported";
    //Scanning
    public final String logAlreadyScanning = "Scanning already in progress";
    public final String logScanStartFail = "Scan failed to start";
    public final String logNotScanning = "Not scanning";
    //Bonding
    public final String logBonded = "Device already bonded";
    public final String logBonding = "Device already bonding";
    public final String logUnbonded = "Device already unbonded";
    public final String logBondFail = "Device failed to bond on return";
    public final String logUnbondFail = "Device failed to unbond on return";
    //Connection
    public final String logPreviouslyConnected = "Device previously connected, reconnect or close for new device";
    public final String logConnectFail = "Connection failed";
    public final String logNeverConnected = "Never connected to device";
    public final String logIsNotConnected = "Device isn't connected";
    public final String logIsNotDisconnected = "Device isn't disconnected";
    public final String logIsDisconnected = "Device is disconnected";
    public final String logNoAddress = "No device address";
    public final String logNoDevice = "Device not found";
    public final String logReconnectFail = "Reconnection to device failed";
    //Discovery
    public final String logAlreadyDiscovering = "Already discovering device";
    public final String logDiscoveryFail = "Unable to discover device";
    //Read/write
    public final String logNoArgObj = "Argument object not found";
    public final String logNoService = "Service not found";
    public final String logNoCharacteristic = "Characteristic not found";
    public final String logNoDescriptor = "Descriptor not found";
    public final String logReadFail = "Unable to read";
    public final String logReadFailReturn = "Unable to read on return";
    public final String logSubscribeFail = "Unable to subscribe";
    public final String logSubscribeAlready = "Already subscribed";
    public final String logUnsubscribeFail = "Unable to unsubscribe";
    public final String logUnsubscribeAlready = "Already unsubscribed";
    public final String logWriteFail = "Unable to write";
    public final String logWriteFailReturn = "Unable to write on return";
    public final String logWriteValueNotFound = "Write value not found";
    public final String logWriteValueNotSet = "Write value not set";
    public final String logReadDescriptorFail = "Unable to read descriptor";
    public final String logReadDescriptorFailReturn = "Unable to read descriptor on return";
    public final String logWriteDescriptorNotAllowed = "Unable to write client configuration descriptor";
    public final String logWriteDescriptorFail = "Unable to write descriptor";
    public final String logWriteDescriptorValueNotFound = "Write descriptor value not found";
    public final String logWriteDescriptorValueNotSet = "Write descriptor value not set";
    public final String logWriteDescriptorFailReturn = "Descriptor not written on return";
    public final String logRssiFail = "Unable to read RSSI";
    public final String logRssiFailReturn = "Unable to read RSSI on return";
    //Request Connection Priority
    public final String logRequestConnectionPriorityNull = "Request connection priority not set";
    public final String logRequestConnectionPriorityInvalid = "Request connection priority is invalid";
    public final String logRequestConnectionPriorityFailed = "Request connection priority failed";
    //MTU
    public final String logMtuFail = "Unable to set MTU";
    public final String logMtuFailReturn = "Unable to set MTU on return";

    public final String logRequiresAPI21 = "Requires API level 21";

    public final String operationConnect = "connect";
    public final String operationDiscover = "discover";
    public final String operationRssi = "rssi";
    public final String operationRead = "read";
    public final String operationSubscribe = "subscribe";
    public final String operationUnsubscribe = "unsubscribe";
    public final String operationWrite = "write";
    public final String operationMtu = "mtu";

    public final String baseUuidStart = "0000";
    public final String baseUuidEnd = "-0000-1000-8000-00805F9B34FB";

    //Client Configuration UUID for notifying/indicating
    public final UUID clientConfigurationDescriptorUuid = UUID.fromString("00002902-0000-1000-8000-00805F9B34FB");
    ...
    */
    ...
    private void discoverAction(JSONArray args, CallbackContext callbackContext) {
        ...
        LOG.i("BLE", "discover services of " + device.getName());
    ...
    private boolean subscribeAction(Operation operation) {
        ...
        LOG.i(
                ...
                "writeDescriptor value " +
                        ...
                        " to characteristic " + characteristicUuid.toString()
        );
    ...
    private boolean writeAction(Operation operation) {
        ...
        LOG.i("BLE", "write \"" + Utils.bytesToHex(value) + "\" to characteristic " + characteristicUuid.toString());
        LOG.i("BLE", "write type: " + writeType);
    ...
    public void AddSequentialCallbackContext(UUID characteristicUuid, HashMap<Object, Object> connection, String operationType, CallbackContext callbackContext) {
        HashMap<Object, Object> characteristicCallbacks = EnsureCallback(characteristicUuid, connection);
    ...
    public HashMap<Object, Object> getConnection(String address) {
    ...
    public byte[] getPropertyBytes(JSONObject obj, String key) {
    ...
    private byte[] getPropertyBytes(JSONObject obj, String key, boolean allowEmpty) {
        if (!allowEmpty) return getPropertyBytes(obj, key);

        String string = obj.optString(key, "");
    ...
    private BluetoothGattCallback bluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            LOG.i("BLE", "onServicesDiscovered of " + device.getName() + ", status: " + status);
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                callbackContext.success(returnObj);
                LOG.i("BLE", "onServicesDiscovered of " + device.getName() + " success");
            } else {
                //Else it failed
                addProperty(returnObj, keyError, errorDiscover);
                addProperty(returnObj, keyMessage, logDiscoveryFail);
                callbackContext.error(returnObj);
                LOG.i("BLE", "onServicesDiscovered of " + device.getName() + " fail");
            }
        }

        @Override
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            LOG.i("BLE", "onCharacteristicRead with value " + Utils.bytesToHex(characteristic.getValue()));
            //Get the connected device
            BluetoothDevice device = gatt.getDevice();
            String address = device.getAddress();
...
//            LOG.i("BLE", "onCharacteristicChanged(2 param) with value " + Utils.bytesToHex(characteristic.getValue()));
            //Get the connected device
            BluetoothDevice device = gatt.getDevice();
            String address = device.getAddress();
...
//            LOG.i("BLE", "onCharacteristicChanged(2 param) characteristic " + characteristicUuid.toString() + " send result to js callback");
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, byte[] value) {
            LOG.i("BLE", "onCharacteristicChanged(3 param) with value " + Utils.bytesToHex(value));
            //Get the connected device
            BluetoothDevice device = gatt.getDevice();
            String address = device.getAddress();
            ...
            LOG.i("BLE", "onCharacteristicChanged(3 param) characteristic " + characteristicUuid.toString() + " send result to js callback");
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            ...
            LOG.i("BLE", "onDescriptorWrite descriptor: " + descriptorUuid.toString() + ", status: " + status);
